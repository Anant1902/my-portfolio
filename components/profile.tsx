...
export default function Profile() {
    ...
    return (
        <Flex w="100%" maxW="1180px" mx="auto" px={{ base: 5, md: 10 }} pb={{ base: 16, md: 24 }}>
            <Box w="100%">
                <Box mb={8}>
                    <Text fontWeight="800" fontSize={{ base: "3xl", md: "4xl" }}>More about me!</Text>
                    <Text color={muted} mt={2} maxW="760px">
                        Production engineering experience with AI interfaces, scalable service integrations,
                        data-heavy workflows, and strong testing habits.
                    </Text>
                </Box>
